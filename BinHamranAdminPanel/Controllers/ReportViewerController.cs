...
namespace BinHamranAdminPanel.Controllers
{
  ...
  public class ReportViewerController : Controller
  {
    ...
    {      
      ...
      string companyBranchCode = data.GetValue("companyBranchCode").ToString();
      StiReport report = new StiReport();
      var path = StiNetCoreHelper.MapPath(this, "/Reports/DepreciationOfFixedAssets.mrt");
      report.Load(path);
      report["FromDate"] = sdate;
      report["ToDate"] = edate;
      report["@STARTDATE"] = sdate;
    ...
    {      
      ...
      string companyBranchCode = data.GetValue("companyBranchCode").ToString();
      StiReport report = new StiReport();
      var path = StiNetCoreHelper.MapPath(this, "/Reports/TotalExclusionOfFixedAssets.mrt");
      report.Load(path);
      report["FromDate"] = sdate;
      report["ToDate"] = edate;
      report["@STARTDATE"] = sdate;
    ...
    {      
      ...
      string companyBranchCode = data.GetValue("companyBranchCode").ToString();
      StiReport report = new StiReport();
      var path = StiNetCoreHelper.MapPath(this, "/Reports/FixedAssetsAdditions.mrt");
      report.Load(path);
      report["FromDate"] = sdate;
      report["ToDate"] = edate;
      report["@STARTDATE"] = sdate;
    ...
    {      
      ...
      string companyBranchCode = data.GetValue("companyBranchCode").ToString();
      StiReport report = new StiReport();
      var path = StiNetCoreHelper.MapPath(this, "/Reports/FixedAssetsOfInstitution.mrt");
      report.Load(path);
      report["FromDate"] = sdate;
      report["ToDate"] = edate;
      report["@STARTDATE"] = sdate;
    ...
    {
      var path = StiNetCoreHelper.MapPath(this, "\\Reports\\");
      return path;
    }
